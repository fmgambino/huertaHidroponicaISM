const SHELL='huerta-h2-shell-v2.14.0';
const ACTIVE='huerta-patch-active';
const ASSETS=['./','./index.html','./assets/css/app.css?v=2.14.0','./assets/css/v21.css?v=2.14.0','./assets/js/config.js?v=2.14.0','./assets/js/app.js?v=2.14.0','./assets/icons/icon.svg','./manifest.webmanifest'];
